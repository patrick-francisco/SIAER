...
simpliciti/Applications/application/Access\ Point/main_AP_Async_Listen_autoack.obj: ../simpliciti/Applications/application/Access\ Point/main_AP_Async_Listen_autoack.c $(GEN_OPTS) $(GEN_SRCS)
	...
	$(shell echo --cmd_file="C:\Users\Patrick\SIAER\SIAER\simpliciti\Applications\configuration\End_Device\smpl_config.dat" --cmd_file="C:\Users\Patrick\SIAER\SIAER\simpliciti\Applications\configuration\smpl_nwk_config.dat" > "simpliciti/Applications/application/Access Point/main_AP_Async_Listen_autoack_ccsCompiler.opt")
