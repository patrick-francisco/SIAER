...
\caption[Investimentos Iniciais]{Previsão dos principais investimentos iniciais}\label{tableInvestimentos} \\
...
\hhline{----}
	 \gnumericPB{\centering}\textbf{Período}
	&\gnumericPB{\centering}\textbf{Classificação}
...
\hhline{----}
	...
	&\gnumericPB{\raggedright}\gnumbox[l]{Máquinas e equipamentos}
	&\gnumericPB{\centering}\gnumbox{$                    8.000 $}
\\
	 \gnumericPB{\centering}\gnumbox{2011}
	&\gnumericPB{\centering}\gnumbox{Imobilizado}
	&\gnumericPB{\raggedright}\gnumbox[l]{Móveis e utensílios}
...
\\
	 \gnumericPB{\centering}\gnumbox{2011}
	&\gnumericPB{\centering}\gnumbox{Imobilizado}
	&\gnumericPB{\raggedright}\gnumbox[l]{Obras civis e/ou reformas}
	&\gnumericPB{\centering}\gnumbox{$                   10.150 $}
\\
	 \gnumericPB{\centering}\gnumbox{2011}
	&\setlength{\gnumericMultiRowLength}{0pt}%
	 \addtolength{\gnumericMultiRowLength}{\gnumericColC}%
	 \multirow{2}[1]{\gnumericMultiRowLength}{\parbox{\gnumericMultiRowLength}{%
	 \gnumericPB{\centering}Despesas gerais}}
	&\setlength{\gnumericMultiRowLength}{0pt}%
	 \addtolength{\gnumericMultiRowLength}{\gnumericColD}%
	 \multirow{2}[1]{\gnumericMultiRowLength}{\parbox{\gnumericMultiRowLength}{%
	 \gnumericPB{\raggedright}Despesas de constituição da empresa e liberação de alvará}}
	&\setlength{\gnumericMultiRowLength}{0pt}%
	 \addtolength{\gnumericMultiRowLength}{\gnumericColE}%
	 \multirow{2}[1]{\gnumericMultiRowLength}{\parbox{\gnumericMultiRowLength}{%
	 \gnumericPB{\centering}\gnumbox{$                    3.500 $}}}
\\
...
\hhline{----}
	...
	&
	&
	&\gnumericPB{\centering}\gnumbox{\textbf{$                   31.150 $}}
\\
\hhline{----}
\end{longtable}
