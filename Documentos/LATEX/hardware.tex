...
A placa de interfaceamento é relativamente simples, basta conectar os seis pinos da placa de debug (~\ref{fig:conector_ez430}) aos correspondentes pinos da placa EM430F6137RF900(~\ref{fig:jtag}). A seqüência é a seguinte: GND-GND, 3.6V - Vcc, TEST-TST,RST-RST e os pinos TX e RX com os pinos P1.5 E P1.6 do CC430.
